...
require (
	...
	github.com/platform-mesh/account-operator v0.14.1
	github.com/platform-mesh/golang-commons v0.15.6
	github.com/platform-mesh/security-operator v0.29.3
...
require (
	...
	github.com/platform-mesh/subroutines v0.3.0 // indirect
