...
require (
	...
	github.com/platform-mesh/account-operator v0.12.34
	github.com/platform-mesh/golang-commons v0.14.0
	github.com/platform-mesh/security-operator v0.27.18
...
require (
	...
	github.com/platform-mesh/subroutines v0.2.6 // indirect
