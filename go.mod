...
require (
	...
	github.com/platform-mesh/account-operator v0.12.26
	github.com/platform-mesh/golang-commons v0.13.18
	github.com/platform-mesh/security-operator v0.27.1
...
require (
	...
	github.com/platform-mesh/subroutines v0.2.1 // indirect
